...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // username or email
  // find the user
  // check if user is there or not otherwise create new user
  //check password
  // access and refreshtoken
  // send cookies which is secure
  // this is the algo
  ...
  //sent in cookies.
  //what information is to send to the user.
  ...
  const options = {
    httpOnly: true, // cookies sirf server se modify ho skti hai
    secure: true,
  };
...
const watchHistory = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, history, "watch history fetched succesfully"));
});
